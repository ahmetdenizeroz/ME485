...
gmsh.model.add("my_python_model")

lc = 4e-1
# The first type of `elementary entity' in Gmsh is a `Point'.
# To create a point with the built-in CAD kernel,
# the Python API function is gmsh.model.geo.addPoint():
...
#As a general rule, elementary entity tags in Gmsh have to be
# unique per geometrical dimension.
