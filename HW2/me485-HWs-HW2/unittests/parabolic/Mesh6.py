...
gmsh.model.geo.mesh.setTransfiniteCurve(l1, 25)
gmsh.model.geo.mesh.setTransfiniteCurve(l2, 25)
gmsh.model.geo.mesh.setTransfiniteCurve(l3, 25)
gmsh.model.geo.mesh.setTransfiniteCurve(l4, 25)
