...
gmsh.model.geo.mesh.setTransfiniteCurve(l8, la)

gmsh.model.geo.mesh.setTransfiniteCurve(l1, la)
gmsh.model.geo.mesh.setTransfiniteCurve(l2, la)
gmsh.model.geo.mesh.setTransfiniteCurve(l3, la)
gmsh.model.geo.mesh.setTransfiniteCurve(l4, la)

gmsh.model.geo.mesh.setTransfiniteCurve(l13, la)
gmsh.model.geo.mesh.setTransfiniteCurve(l14, la)
gmsh.model.geo.mesh.setTransfiniteCurve(l15, la)
gmsh.model.geo.mesh.setTransfiniteCurve(l16, la)
